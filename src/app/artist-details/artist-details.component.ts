...
export class ArtistDetailsComponent implements OnInit {
  ...
  //This is for Artist details
artistinfo:Array<Object>=[];
artistbio = new Set();
summary;
published;
link;
...
playcount;
  ...
  searchartist(){
    this.searchres=true;
  this.service.getArtist(this.query,'getinfo').subscribe(res=>{
      ...
      this.service.getArtist(this.query, 'gettoptracks').subscribe((res: any) => {
